...
namespace TransportCompany.DAL.Migrations
{
    ...
    [Migration("20221223214128_OTKAZANO")]
    partial class OTKAZANO
    {
            ...
            modelBuilder.Entity("TransportCompany.Domain.Entities.Request", b =>
                {
                    ...
                    b.HasCheckConstraint("Status", "Status LIKE 'Обрабатывается' OR Status LIKE 'Сформирована' OR Status LIKE 'Доставляется' OR Status LIKE 'Выполнена' OR Status LIKE 'Прервана' OR Status LIKE 'Отказано'");

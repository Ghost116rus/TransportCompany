        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transportation_Total_time", "Total_time > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Driver_license_number = table.Column<string>(type: "char(10)", nullable: true),
                    Transport_vehicleVehicle_identification_number = table.Column<string>(type: "char(17)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Request_Status", "Status LIKE 'Обрабатывается' OR Status LIKE 'Сформирована' OR Status LIKE 'Доставляется' OR Status LIKE 'Выполнена' OR Status LIKE 'Отказана'");
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Driver_license_number,
                        principalTable: "Driver",
                        principalColumn: "Driver_license_number");
                    table.ForeignKey(
                        name: "FK_Request_Transport_vehicle_Transport_vehicleVehicle_identification_number",
                        column: x => x.Transport_vehicleVehicle_identification_number,
                        principalTable: "Transport_vehicle",
                        principalColumn: "Vehicle_identification_number");
                    table.ForeignKey(
